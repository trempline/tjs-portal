...
export const routes: Routes = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'event-requests/:id', component: HostArtistRequestDetail, canActivate: [roleGuard(['Committee Member'])] },
            ...
            { path: 'events/:id', component: HostEventDetail, canActivate: [roleGuard(['Committee Member'])] },

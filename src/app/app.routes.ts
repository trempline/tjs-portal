...
export const routes: Routes = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'artists/non-tjs', component: NonTjsArtists, canActivate: [roleGuard(['Admin', 'Community Member'])] },
            { path: 'artists/non-tjs/:id', component: CommitteeArtistDetail, canActivate: [roleGuard(['Admin', 'Community Member'])] },
            ...
            { path: 'host-manager/artists/invited', component: Artists, canActivate: [roleGuard(['Host Manager'])] },
            { path: 'host-manager/artists/non-tjs', component: NonTjsArtists, canActivate: [roleGuard(['Host Manager'])] },
            { path: 'host-manager/artists/non-tjs/:id', component: CommitteeArtistDetail, canActivate: [roleGuard(['Host Manager'])] },

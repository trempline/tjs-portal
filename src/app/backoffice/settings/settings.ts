...
@Component({
  ...
  template: `
    <div class="space-y-6">
      <div>
        <h1 class="text-2xl font-bold text-zinc-900">Paramètres</h1>
        <p class="text-sm text-zinc-500 mt-0.5">Configurez les paramètres de l'application.</p>
      </div>
      ...
      <div class="bg-white rounded-xl border border-zinc-200 shadow-sm p-12">
        <div class="flex flex-col items-center justify-center text-zinc-400">
          ...
          <p class="text-sm font-medium">Paramètres de l'application</p>
